...
public class SimulatorView extends JFrame {
	...
	public SimulatorView(int height, int width, Simulator simulator) {
		...
		// ƒen stap JButton instantieren en een actionListener implementeren
		oneStep = new JButton("1 stap");

		// Honderd stappen JButton instantieren en een actionListener
		// implementeren
		hundredStep = new JButton("100 stappen");

		//aantal stappen meegeven
		giveStep = new JButton("aantal stappen");
		// Reset knop
		...
		this.circlestatsview = new CircleStats(stats);
		...
		leftPanel.add(start);
		leftPanel.add(stop);
		leftPanel.add(giveStep);
		leftPanel.add(circlestatsview);
	...
	public JButton getOneStep(){
		return oneStep;
		
	}
	
	public JButton getHunderdStep() {
		return hundredStep;
	}
	
	public JButton getGiveStep() {
		return giveStep;
	}
	
	public JButton getResetStep() {
		return reset;
	}
	
	public JButton getStartStep() {
		return start;
	}
	
	public JButton getStopStep() {
		return stop;
	}
	...
	public CircleStats getCircleStats()
	{
