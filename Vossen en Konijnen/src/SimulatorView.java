...
public class SimulatorView extends JFrame {
	...
	/*
	 * Inner class OneStepHandler implementeren. Deze klasse wordt aangeroepen
	 * als er op de simuleer 1 step JButton wordt geklikt
	 */
	public class OneStepHandler implements ActionListener {
	...
	/*
	 * Inner class HundredStepsHandler implementeren. Deze klasse wordt
	 * aangeroepen als er op de simuleer 100 steps JButton wordt geklikt
	 */
