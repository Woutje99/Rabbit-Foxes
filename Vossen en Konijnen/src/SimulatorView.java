...
public class SimulatorView extends JFrame
{
    ...
    /*
     * Inner class OneStepHandler implementeren. Deze klasse wordt aangeroepen als 
     * er op de simuleer 1 step JButton wordt geklikt
     */
    ...
    /*
     * Inner class HundredStepsHandler implementeren. Deze klasse wordt aangeroepen
    ...
    public class HundredStepsHandler implements ActionListener {
    	public void actionPerformed(ActionEvent e) {
    		new Thread() {
    			public void run() {
    				String s = (String)JOptionPane.showInputDialog (null ,"Aantal stappen"); 
